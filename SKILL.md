...
- 从近期原文标注用户类型（DIY、施工队、租赁/维修商等）、使用场景、购买理由、失效部位、安装/适配问题、包装物流和复购意图；再归入产品、页面/适配表、包装/物流、不可接受四类动作。
...
7. **评论与适配风险**：报告时间范围、父体与目标子体/变体的评论归属、主题频率、用户类型、严重度、产品可修复、页面可修复和不可修复问题。
